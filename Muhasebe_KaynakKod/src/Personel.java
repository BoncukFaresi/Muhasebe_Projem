...
public class Personel extends JFrame implements ActionListener,MouseListener,WindowListener{
	...
	String[] col= {"ID","Ýsim","SoyÝsim","Maaþ","Telefon Numarasý","Pozisyon"};
	...
	Personel() throws SQLException{
		...
		this.setTitle("Personel Ýþlemleri");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==kayýtbtn) {
			...
			try {
				String kullanici = JOptionPane.showInputDialog("Kullanýcý Adýný Girin:");
				String Sifre = JOptionPane.showInputDialog("Þifre Giriniz:");
